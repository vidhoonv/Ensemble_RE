...
public class scorer {
	...
	while ((line = responseReader.readLine()) != null) {
	    ...
	    if(doc_id.equals("NIL")){
	    	mpConfidence.put(query_id+":NIL", confidence);
	    }
	    else{
	    	mpConfidence.put(query_id+answer_string, confidence);
	    }
	...
	for (String query : slots) {
		...
		if (doc_id.equals("NIL")) {
		    ...
		    if(symbol.equals("c"))
		    	mpTarget.put(query+":NIL",1);
		    else
		    	mpTarget.put(query+":NIL",0);
		} else /* non-NIL system response */ {
		    num_responses++;
		    String key = query + ":" + responseString;
		    String kTarget = query + ":" + fields[4];
		    String J = judgement.get(key);
		    if (J == null) {
